...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: 'Multi-functional electric pressure cooker with 9 cooking functions including pressure cook, slow cook, rice cooker, steamer, sauté pan, yogurt maker, warmer, and sterilizer.',
    price: 89.99,
    ...
    specifications: {
      'Capacity': '6 Quart',
      'Power': '1000W',
      'Functions': '9-in-1 Multi-Use',
      'Display': 'Large LCD',
      'Material': 'Stainless Steel Inner Pot',
      'Safety Features': '10+ Built-in Safety Features',
    },
    features: [
      '9 cooking functions in one appliance',
  ...
  {
    id: 'home-009',
    name: 'KitchenAid-Style Stand Mixer 5.5 Qt',
    description: 'Professional-grade stand mixer with 10 speeds, planetary mixing action, and included attachments. Perfect for baking enthusiasts.',
    price: 129.99,
  ...
  {
    id: 'home-014',
    name: 'Premium Electric Kettle with Temperature Control',
    description: 'Gooseneck electric kettle with precise temperature control, keep-warm function, and elegant design. Perfect for pour-over coffee and tea.',
    price: 79.99,
    ...
    features: [
      ...
      'Variable temperature control (1°F increments)',
